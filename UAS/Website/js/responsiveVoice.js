            ...
            a.responsivevoices = [
                {
                    ...
                    lang: "en-GB",
                    voiceIDs: [
                        3, 7, 171, 278, 201, 5, 1, 257, 286, 342, 258, 287, 343,
                        8,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "en-US",
                    voiceIDs: [
                        39, 40, 41, 42, 383, 205, 204, 43, 173, 235, 283, 339,
                        408, 44,
                    ],
                },
                {
                    ...
                    lang: "en-US",
                    voiceIDs: [
                        234, 282, 338, 236, 284, 340, 237, 382, 2, 4, 0, 6, 7,
                        75, 159,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "zh-CN",
                    voiceIDs: [
                        249, 58, 59, 380, 281, 231, 155, 60, 191, 268, 297, 353,
                        269, 298, 354, 409, 61,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "zh-HK",
                    voiceIDs: [
                        192, 193, 232, 250, 251, 270, 299, 355, 409, 252,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "zh-TW",
                    voiceIDs: [
                        194, 233, 253, 254, 305, 322, 361, 384, 319, 336, 375,
                        409, 255,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "de-DE",
                    voiceIDs: [
                        27, 28, 29, 30, 78, 170, 275, 199, 31, 261, 290, 346,
                        262, 291, 347, 32,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "fr-FR",
                    voiceIDs: [
                        240, 21, 22, 23, 77, 178, 279, 210, 266, 295, 351, 304,
                        321, 360, 26,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "it-IT",
                    voiceIDs: [
                        242, 33, 34, 35, 36, 37, 79, 181, 216, 271, 300, 356,
                        38,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "ja-JP",
                    voiceIDs: [
                        248, 50, 51, 280, 217, 52, 153, 182, 273, 302, 358, 274,
                        303, 359, 53,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "ko-KR",
                    voiceIDs: [
                        54, 55, 56, 156, 183, 218, 306, 323, 362, 384, 57,
                    ],
                },
                {
                    name: "Korean Male",
                ...
                },
                {
                    ...
                    lang: "pl-PL",
                    voiceIDs: [
                        244, 120, 119, 121, 185, 222, 267, 296, 352, 122,
                    ],
                },
                {
                    name: "Polish Male",
                ...
                },
                {
                    ...
                    lang: "es-ES",
                    voiceIDs: [
                        19, 238, 16, 17, 18, 20, 76, 174, 207, 263, 292, 348,
                        264, 293, 349, 15,
                    ],
                },
                {
                ...
                if (a.rvsMapped) {
                    ...
                    if (a.isPlaying())
                        ...
                        if (a.checkSpeechAllowed()) {
                            ...
                            a.msgprofile = f;
                            a.log(
                                "Voice picked: " + a.msgprofile.systemvoice.name
                            );
                            a.utterances = [];
                            a.fallbackChunks = [];
                                ...
                                if (
                                    ...
                                    e =
                                        ...
                                        (f.collectionvoice.lang ||
                                            ...
                                            "en-US") +
                                        "&sv=" +
                                        (f.collectionvoice.service ||
                                            f.systemvoice.service ||
                                            "") +
                                        "&vn=" +
